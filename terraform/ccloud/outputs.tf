output "resource-ids" {
  ...
  ${confluent_service_account.app-kstreams.display_name}:                    ${confluent_service_account.app-kstreams.id}
  ${confluent_service_account.app-kstreams.display_name}'s Kafka API Key:    "${confluent_api_key.app-kstreams-kafka-api-key.id}"
  ${confluent_service_account.app-kstreams.display_name}'s Kafka API Secret: "${confluent_api_key.app-kstreams-kafka-api-key.secret}"
